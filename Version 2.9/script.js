...
document.getElementById('btn-video').addEventListener('click', function () {
    window.location.href = 'vidéos/video.html';
})

// Co-dev bouton
document.getElementById('btn-co-dev').addEventListener('click', function () {
    window.location.href = 'dev-space/connexion/connexion.html';
})

// Podcast bouton
document.getElementById('btn-podc').addEventListener('click', function () {
    window.location.href = 'vidéos/podcast.html';
})
